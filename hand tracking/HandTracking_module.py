...
class handDetector():
    ...
    def findHands(self, frame, draw=True): # put a "draw" flag,
        ...
        # use the results received and extract the information within
        ...
        if self.results.multi_hand_landmarks:
            ...
            for handLms in self.results.multi_hand_landmarks:
                # check if we want to draw or not
                if draw:
                    # use mpDraw to write landmarks
    ...
    # find distance between 2 TipIds
...
# if we running this script
if __name__ == "__main__":
    main() # then do this
# what we write in the main part will be like a dummy code that will be used to showcase what can this module do